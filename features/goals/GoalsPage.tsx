...
import { goalPercentage, GOAL_PRIORITY_LABEL, GOAL_TYPE_LABEL } from './domain';
...
export function GoalsPage() {
  const { goals } = useGoals(); const { projects } = useProjects(); const { tasks, repository } = useTasks(); const [selectedId, setSelectedId] = useState<string | null>(null); const [linking, setLinking] = useState(false);
